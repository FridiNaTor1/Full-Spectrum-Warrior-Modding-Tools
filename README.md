...
A portable C++20 implementation covers the core patchers (DLL tweaks, PAK mission failure removal, ammo 999, and `Resolution.cfg` writing) and now ships as both a CLI and Qt GUI.
...
```
Select your install directory, then click the patch buttons or adjust the resolution fields before writing `Resolution.cfg`.
